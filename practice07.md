...
GitHub Pagesにウェブコンテンツをアップロードするには、FTPアプリではなくGitまたはGit互換アプリを使います。ここでは「GitHub Desktop」を使用するものとします。
...
#### 備考
   ...
   * コミットCommitにより、ローカルリポジトリ内にファイルのバックアップが保存され、且つ、変更履歴が記録されます。
   * プッシュPushにより、リモートリポジトリ内にファイルのバックアップが保存され、且つ、変更履歴が記録されます。
